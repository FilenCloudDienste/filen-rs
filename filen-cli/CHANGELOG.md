...
- `search` command to globally search for files and directories in the drive (interactive and non-interactive modes)
...
- `stat <directory>` and `stat /` now show total size and amount of files and directories
